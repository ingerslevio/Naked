...
exports.config = {
  ...
  watch:
    sourceDir: "Client/src"                # directory location of web assets, can be relative to
                                         # the project root, or absolute
    compiledDir: "Client/build"              # directory location of compiled web assets, can be
  ...
  server:                      # configuration for server when server option is enabled via CLI
    ...
    #   compileWith: 'eco'      # Valid options: "jade", "hogan", "html", "ejs", "handlebars", "dust".
    #                              # The compiler for your views.
    #   extension: 'eco'        # extension of your server views
    #   path: 'Client/views'            # This is the path to project views, it can be absolute or
